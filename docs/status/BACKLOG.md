...
| P3 deploy | P3 | Finish CMS edge: Caddy `/static*` + rotate admin password + TOTP | RISK-0009 OPEN after smoke PASS; CSS 404 until `/static*` | Project owner | LOG-0126, Caddyfile.cms.snippet, smoke-cms.sh |
