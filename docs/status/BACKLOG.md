...
| QA-playwright | QA | Playwright config کامل + lifecycle browser suite | DONE (`DEFER-0026` CLOSED LOG-0180); §18 remainder `DEFER-0032` | Project owner | `apps/web/qa/e2e/README.md` |
