...
|---|---|---|---|---|---|
| OWNER_CUTOVER | OPS | Rebuild-web PASS [32555455704](https://github.com/tahamohamadi-ir/Taha-personal-platform/actions/runs/32555455704); remaining: scheduled-publish timer (`install-scheduled-publish-timer.sh`) → optional HMAC (`DEFER-0027`) / Caddy edge (`DEFER-0031`) | Keep `CMS_CD_AUTO_MIGRATE` unset; owner interactive SPA MFA | Project owner | LOG-0199; LOG-0196 |
