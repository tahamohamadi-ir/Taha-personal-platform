...
| ADM-1 | ADM | Custom admin foundation: Ninja admin auth + CRUD + React SPA shell (dashboard/list/form, RTL) + migrate Wagtail-session admins + cutover | ADM-0 — **auth + SPA scaffold DONE (LOG-0156); CRUD + cutover باقی** | Project owner | Task-list §17 |
