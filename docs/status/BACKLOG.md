...
| ADM-4 | ADM | Workflow transitions + translation queue + content health | ADM-2/ADM-3 — **DONE (LOG-0161 + LOG-0180): lifecycle + translation queue + content health + revisions/schedule (DEBT-0005 CLOSED)** | Project owner | Task-list §17 |
