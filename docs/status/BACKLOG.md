...
| P4 | P4 | Blog/Writing (Article/Series, list/detail, feed) | DONE live (writing-canonical + RSS); feed DEFER-0018 CLOSED | Project owner | Task-list Â§9; LOG-0211; LOG-0216 |
...
| P8 | P8 | Publications/Books/Downloads/Talks | **DONE live** — migrate `0014` + rebuild (LOG-0216); catalogs empty-honest until content | Project owner | Task-list Â§13; LOG-0213; LOG-0216 |
| P9 | P9 | Teaching + Creative | P8 | Project owner | Task-list Â§14 |
| P10 | P10 | Topics + Pagefind search + collections | Pagefind early **live** (LOG-0215/0216); collections still open | Project owner | Task-list Â§15 |
