...
<<<<<<< HEAD
| ADM-6 | ADM | Astro wiring + rebuild trigger + E2E JSON | PARTIAL — HMAC `DEFER-0027`; §18 QA `DEFER-0032`; primaryColor/CV `DEFER-0029` | Project owner | Task-list §17; LOG-0165/0180 |
=======
| ADM-6 | ADM | Astro wiring + rebuild trigger + E2E JSON | PARTIAL — HMAC enable `DEFER-0027`; Playwright `DEFER-0026`; primaryColor/CV `DEFER-0029` CLOSED (LOG-0185); owner VPS migrate `siteconfig.0002` | Project owner | Task-list §17; LOG-0165/0185 |
>>>>>>> origin/main
...
| ADM-5 | ADM | Site settings (nav/header/footer/tokens/SEO) + tags/filters + contact inbox | ADM-4 — **DONE (LOG-0162)** site settings + tags + featured; **CV current-document DONE (LOG-0185)**; contact inbox remains out of scope (`DEFER-0007` / `DEBT-0006` RESOLVED) | Project owner | Task-list §17 |
