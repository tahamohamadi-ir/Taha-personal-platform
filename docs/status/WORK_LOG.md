...
- Deferred or risk IDs: `DEFER-0013` OPEN برای visual matrix و zoom واقعی؛ hosted CI و dedicated About regression پس از integration اجرا می‌شوند.
