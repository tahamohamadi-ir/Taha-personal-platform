...
- Non-goals:
  ...
  - Composition → Astro, `primaryColor` CSS injection, CV current-document, contact inbox (`DEBT-0006`, `DEFER-0028`).
...
- Deferred/risk IDs: `DEFER-0026`, `DEFER-0027`, `DEFER-0028`, `DEBT-0003`, `DEBT-0006`, `RISK-0010`.
