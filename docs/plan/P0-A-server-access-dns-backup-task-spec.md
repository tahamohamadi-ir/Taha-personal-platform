...
- Google Drive OAuth/access was verified through rclone; encrypted PostgreSQL and media/config snapshots were created and a `restic check` found no errors. No schedule or restore rehearsal exists yet.
