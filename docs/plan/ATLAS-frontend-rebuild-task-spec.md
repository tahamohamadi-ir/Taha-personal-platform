...
- Keeping `apps/cms` / `apps/cms/admin-frontend` and `apps/web` as a shared writable worktree or merged bundle — **frontend/admin separation is invariant (ADR-0026)** and must not be violated.
