...
| **AF** — Admin frontend SPA | [`TRACK-AF-admin-spa-task-list.md`](TRACK-AF-admin-spa-task-list.md) | `apps/cms/admin-frontend/**` | consumes frozen AB endpoint contracts; RTL-first fa/en | BLOCKED until AB-02+ |
