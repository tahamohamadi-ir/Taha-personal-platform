...
| `ADM-6-frontend-wiring-task-spec.md` | PARTIAL | agent | HMAC `DEFER-0027`; Playwright lifecycle `DEFER-0026` CLOSED (LOG-0180); §18 remainder `DEFER-0032`; story projection shipped on `b6bea6a`. |
