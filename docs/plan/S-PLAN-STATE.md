...
| D7 | P3 runtime deploy (Compose/Caddy/MFA/DB) | DONE | owner/L-model | Runtime live 2026-08-16; RISK-0009 CLOSED (LOG-0129). Residual: RISK-0003 CMS backup/restore evidence (P3-cms-backup-restore-task-spec); DEFER-0015 recovery codes; `/api/`/`/media/` unpublished |
