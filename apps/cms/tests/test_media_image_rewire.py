...
@pytest.mark.django_db
def test_public_article_exposes_active_featured_image(api_client, media_root):
...
@pytest.mark.django_db
def test_public_project_diagram_screenshot_image_urls(api_client, media_root):
