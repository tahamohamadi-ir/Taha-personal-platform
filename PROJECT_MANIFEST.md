...
| Logo | Approved asset only; no invented geometry | CLOSED (owner 2026-08-26): authoritative mark = `Assets/site-redesign/brand/taha-mark-primary.png` + `taha-mark-favicon.png`; reuse without redrawing (ATLAS-03). Previously OPEN: â€” existing authoritative logo reused without redrawing (ATLAS-03) |
